...
async function collect() {
  ...
  const [mag, plasma, enlil, hp, kp, sc, kf, dst, hemi, aurora, hp30txt] = await Promise.all([
  ...
  return { mag, plasma, enlil, hp, kp, sc, kf, dst, hemi, aurora, hp30txt, fetchedAt: Date.now() };
}
